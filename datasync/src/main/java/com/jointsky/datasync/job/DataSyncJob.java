package com.jointsky.datasync.job;
...
import com.jointsky.datasync.util.ConfigUtil;
import com.jointsky.datasync.util.DateUtil;
...
public class DataSyncJob implements BeanNameAware {
	...
	@Autowired private ConfigUtil configUtil;	//配置文件工具类
